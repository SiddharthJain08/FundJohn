...
def test_driver_accepts_v2_with_gate():
    ...
    After the gate, dispatch hands off to _run_prices which raises
    NotImplementedError. We assert we made it past the gate by looking for
    the stub's marker text in the traceback, NOT for the REFUSED string.
    """
    ...
    assert 'NotImplementedError' in combined or 'Task 7' in combined, (
