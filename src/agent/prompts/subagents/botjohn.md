...
## Cycle Execution
1. Data pipeline runs automatically (hardcoded): strategies executed, memos written to disk
2. Spawn ResearchJohn with memo directory path
3. Await research report from ResearchJohn (#research)
4. Spawn TradeJohn with report path + portfolio state
5. Review signals: approve EV > 0 within 3% NAV limit, auto-veto negative EV
6. Post cycle digest to #ops
